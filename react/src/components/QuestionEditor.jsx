                    ...
                    <div className="flex items-center">
                     ...
                     rounded-sm text-white bg-gray-600 hover:bg-gray-700"
                        ...
                        <button
                            type="button"
                            className="flex items-center text-xs py-1 px-3 mr-2
                     rounded-sm border border-transparent text-red-500 text-red-500 hover:bg-red-600 font-semibold"
                    ...
                    {shouldHaveOptions() && <div>
                        <div>
                            <h4 className="text-sm font-semibold mb-1 flex justify-between items-center">
                                Options
                                <button onClick={addOption} type="button" className="flex items-center text-xs py-1 px-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700">
                                    Add
                                </button>
                            </h4>
                            {
