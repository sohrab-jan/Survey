            ...
            <fieldset className="mb-4">
                ...
                <div className="mt-3">
                    {question.type === "select" && (
                        <select onChange={(ev) => answerChanged(ev.target.value)}
                            className="mt-1 block w-full border  border-gray-300 bg-white
                    ...
                    {question.type === "text" && (
                        <div>
                            <input
                                type="text"
                                onChange={(ev => answerChanged(ev.target.value))}
                                className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block wp-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                            />
                        </div>
                    )}
