...
export default function SurveyPublicView() {
  ...
  useEffect(() => {
    setLoading(true);
    axiosClient.get(`surveys/get-by-slug/${slug}`).then(({ data }) => {
      setLoading(false);
      setSurvey(data.data);
    })
      .catch(() => {
  ...
  return (
    <div>
      ...
      {!loading && <form className="container mx-auto" onSubmit={ev => onSubmit(ev)}>
        <div className="grid grid-cols-6">
          <div className="mr-4"><img src={survey.image_url} alt={survey.title} /></div>
